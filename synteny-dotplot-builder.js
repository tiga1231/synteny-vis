...
/***/ function(module, exports, __webpack_require__) {
	...
	// tested in node land.
	window.makeSyntenyDotPlot = _main.makeSyntenyDotPlot;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.makeSyntenyDotPlot = function (_ref) {
	  var data_url = _ref.data_url,
	      ...
	      genome_x = _ref.genome_x,
	      genome_y = _ref.genome_y,
	      _ref$gen_coge_seq_lin = _ref.gen_coge_seq_link,
	      gen_coge_seq_link = _ref$gen_coge_seq_lin === undefined ? _cogeUtil.genCogeSequenceLink : _ref$gen_coge_seq_lin;
	  ...
	  _d3Queue2.default.queue().defer(_d2.default.text, data_url).await(function (err, ks) {
	    ...
	    var meta = {
	      ...
	      y_name: y_name,
	      have_ks: have_ks,
	      gen_coge_seq_link: gen_coge_seq_link
	    };
	    _syntenyVis2.default.controller(ksDataObject, element_id, meta);
	  });
	};
	...
	function ksTextToObjects(text) {
	  ...
	  var dots = csvLines.filter(function (line) {
	    return line && line[0] !== '#';
	  }).map(ksLineToSyntenyDot).filter(function (x) {
	    return x;
	  });
	
	  var min_logks = Math.min.apply(Math, _toConsumableArray(dots.filter(function (line) {
	    return isFinite(line.logks);
	  }).map(function (line) {
	    return line.logks;
	  })));
	
	  var min_logkn = Math.min.apply(Math, _toConsumableArray(dots.filter(function (line) {
	    return isFinite(line.logkn);
	  }).map(function (line) {
	    return line.logkn;
	  })));
	
	  return dots.map(function (x) {
	...
	function lengthsToCumulativeBPCounts(len_list) {
	  var ntLenList = len_list.slice().sort(function (a, b) {
	    return a.length - b.length;
	  }).reverse().reduce(function (map, kv) {
	  ...
	  var nameLenList = len_list.slice().sort(function (a, b) {
	  ...
	  var geneCounts = (0, _utils.zipObject)(len_list.map(function (x) {
	    return x.name;
	  }), len_list.map(function (x) {
	    return x.gene_count;
	  }));
	...
	function createDataObj(syntenyDots, xmapPair, ymapPair) {
	  ...
	  var filters = (0, _utils.zipObject)(fields, fields.map(function (field) {
	  ...
	  ret.getXLineOffsets = function () {
	    return Object.values(xmap).sort(function (a, b) {
	      return a - b;
	    });
	  };
	
	  ret.getYLineOffsets = function () {
	    return Object.values(ymap).sort(function (a, b) {
	      return a - b;
	    });
	  };
	  ...
	  ret.currentDataSummary = function currentDataSummary(raw_ticks, field) {
	    var ticks = raw_ticks.map(function (x) {
	      return x;
	    }).sort(function (a, b) {
	      return a - b;
	    });
	    var group = filters[field].group(function (x) {
	      return ticks.find(function (t) {
	        return t >= x;
	      });
	    });
	    ...
	    return function () {
	      ...
	      var groups = (0, _utils.zipObject)(groupList.map(function (x) {
	        return x.key;
	      }), groupList.map(function (x) {
	        return x.value;
	      }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _histogram = __webpack_require__(303);
	
	var _histogram2 = _interopRequireDefault(_histogram);
	
	var _dotplot = __webpack_require__(308);
	
	var _dotplot2 = _interopRequireDefault(_dotplot);
	
	var _d2 = __webpack_require__(300);
	
	var _d3 = _interopRequireDefault(_d2);
	
	var _autoColorscale = __webpack_require__(311);
	...
	var _asyncBenchmark = __webpack_require__(312);
	
	var _asyncBenchmark2 = _interopRequireDefault(_asyncBenchmark);
	
	var _colorscales = __webpack_require__(313);
	...
	var debounced = _utils2.default.debounced;
	...
	function controller(dataObj, element_id, meta) {
	  ...
	  var refreshPlot = debounced(100, function (colorScale) {
	    syntenyPlot.setField(activeField);
	    syntenyPlot.setColorScale(colorScale);
	  });
	
	  var refreshAutoScale = debounced(100, function (persistence) {
	    ...
	    try {
	      for (var _iterator = radio.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    ...
	    if (_constants.SHOW_MAXIMA_AND_MINIMA) histograms.forEach(function (h) {
	  ...
	  function setUpHistograms(initialCS) {
	    ...
	    Object.keys(histograms).filter(function (name) {
	    ...
	    dataObj.addListener(function (typeHint) {
	      if (typeHint.indexOf('stop') > -1 && _constants.SHOW_MAXIMA_AND_MINIMA) Object.values(histograms).forEach(function (h) {
	    ...
	    (function () {
	      var _d3$extent = _d3.default.extent(dataObj.currentData().raw, function (x) {
	        return x.logks;
	          ...
	          minLogKs = _d3$extent2[0],
	          maxLogKs = _d3$extent2[1];
	
	      var points = _utils2.default.samplePointsInRange([minLogKs, maxLogKs], 10);
	
	      var grouped_pairs = points.map(function (lo) {
	        return points.map(function (hi) {
	          return [lo, hi];
	      ...
	      var pairs = Array.prototype.concat.apply([], grouped_pairs);
	
	      _asyncBenchmark2.default.benchmark(pairs, function (range) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _persistence = __webpack_require__(305);
	...
	var _svgTransform = __webpack_require__(307);
	...
	function histogram(id, dataObj, field, colorScale) {
	  var dataExtent = _d2.default.extent(dataObj.currentData().raw.map(function (x) {
	    return x[field];
	  }));
	  ...
	  var getYExtent = function getYExtent(summary) {
	    return [0, 3 / 2 * Math.max.apply(Math, _toConsumableArray(summary.map(function (x) {
	      return x.y;
	    })))];
	  };
	  ...
	  function updateMinMaxMarkers(persistence) {
	    ...
	    var markers = extrema.map(function (d, i, A) {
	      return {
...
/***/ function(module, exports) {
	...
	var indexOfSmallestDifference = function indexOfSmallestDifference(A) {
	  var wrapped = A.map(function (value, index) {
	    return {
	...
	exports.debounced = function (ms, f) {
	  ...
	  return function debounced() {
	    ...
	    if (last_invoke === undefined || Date.now() - last_invoke < ms) {
	      ...
	      timeoutID = setTimeout.apply(undefined, [debounced, ms].concat(args));
	      return;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _labelUtils = __webpack_require__(310);
	
	var _constants = __webpack_require__(304);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var minBy = _utils2.default.minBy,
	    zipObject = _utils2.default.zipObject,
	    zipWith = _utils2.default.zipWith;
	...
	function synteny(id, dataObj, field, initialColorScale, meta) {
	  ...
	  var darknessOfTextGaps = function darknessOfTextGaps(values, scale) {
	    ...
	    }, values, values.slice(1)).map(function (v) {
	      return v > _constants.MIN_GRID_LINE_GAP ? 1 : v / _constants.MIN_GRID_LINE_GAP;
	    }).map(function (v) {
	  ...
	  var filterTextGaps = function filterTextGaps(values, scale, labelSize) {
	    return values.reduce(function (out, next) {
	      if (out.length === 0) return [next];
	      var last = out[out.length - 1];
	      var available = Math.abs(scale(next) - scale(last));
	      var required = (labelSize(next) + labelSize(last)) / 2;
	  ...
	  var getFeatureDescription = function getFeatureDescription(aDbId, bDbId) {
	    return Promise.all([(0, _cogeUtil.getSingleFeatureDescription)(aDbId), (0, _cogeUtil.getSingleFeatureDescription)(bDbId)]).then(function (_ref) {
	      var _ref2 = _slicedToArray(_ref, 2),
	          x = _ref2[0],
	          y = _ref2[1];
	  ...
	  var updateGeVOLink = function updateGeVOLink(x, y) {
	    ...
	    var point = minBy(distance, dataObj.currentData().raw);
	    highlighted = point;
	    ...
	    if (distance(point) * ratio < _constants.GEVO_CLICK_PROXIMITY_THRESHOLD_PIXELS) {
	      _d3.default.select('#gevo-link').text('Compare in GEvo >>>').attr('onclick', function () {
	        var x_feature_id = point.x_feature_id,
	            y_feature_id = point.y_feature_id;
	        var gen_coge_seq_link = meta.gen_coge_seq_link;
	
	        var link = gen_coge_seq_link(x_feature_id, y_feature_id);
	        return 'window.open(\'' + link + '\')';
	      });
	      getFeatureDescription(point.x_feature_id, point.y_feature_id).then(function (_ref3) {
	  ...
	  var xLabelSize = function xLabelSize(offset) {
	    return xOffsetToName[offset].short.length * _constants.ESTIMATED_CHAR_WIDTH_IN_PX;
	  };
	
	  var yLabelSize = function yLabelSize() {
	    return _constants.ESTIMATED_CHAR_HEIGHT_IN_PX;
	  };
	  ...
	  var makeLabels = function makeLabels() {
	    ...
	    var xGridOffsets = xOffsets.filter(xFilter);
	    var yGridOffsets = yOffsets.filter(yFilter);
	
	    var xTextOffsets = filterTextGaps(xMidpoints.filter(xFilter), xScale, xLabelSize);
	    var yTextOffsets = filterTextGaps(yMidpoints.filter(yFilter), yScale, yLabelSize);
	    ...
	    var addXHoverLabel = function addXHoverLabel(x, el) {
	      var _xOffsetToName$x = xOffsetToName[x],
	          short = _xOffsetToName$x.short,
	          full = _xOffsetToName$x.full;
	      ...
	      _d3.default.select(el).append('tspan').attr('x', 0).attr('y', 2 * _constants.ESTIMATED_CHAR_HEIGHT_IN_PX).text(full);
	    };
	
	    var removeXHoverLabel = function removeXHoverLabel(x, el) {
	      _d3.default.select(el).selectAll('tspan').remove();
	    };
	
	    xAxisGapsGroup.call(xLabels);
	    xAxisGapsGroup.selectAll('text').each(function (offset) {
	      var _this = this;
	
	      this.onmouseenter = function () {
	        return addXHoverLabel(offset, _this);
	      };
	      this.onmouseleave = function () {
	        return removeXHoverLabel(offset, _this);
	      };
	    });
	
	    yAxisGapsGroup.call(yLabels);
	    yAxisGapsGroup.selectAll('text').each(function (offset) {
	      this.onmouseenter = function () {
	    ...
	    var tempXOffsetDarknesses = darknessOfTextGaps(xGridOffsets, xScale);
	    var tempYOffsetDarknesses = darknessOfTextGaps(yGridOffsets, yScale);
	  ...
	  var makeGapFilter = function makeGapFilter() {
	    var last = 0;
	    return function (t) {
	      if (t > 0 && t - last < 10000) {
	        return false;
	  ...
	  var makeLabelPair = function makeLabelPair(full) {
	    return {
	      full: full,
	      short: (0, _labelUtils.shortenString)(full, _constants.MAX_SHORT_LABEL_LENGTH)
	    };
	  };
	
	  var xOffsets = dataObj.getXLineOffsets().filter(makeGapFilter());
	  var xMidpoints = midpoints(xOffsets);
	  var xNames = dataObj.getXLineNames().map(makeLabelPair);
	
	  var xOffsetToName = zipObject(xMidpoints, xNames);
	  ...
	  var yNames = dataObj.getYLineNames().map(makeLabelPair);
	
	  var yOffsetToName = zipObject(yMidpoints, yNames);
	  ...
	  var yLabels = yAxisBase().tickFormat(function (y) {
	    var _yOffsetToName$y = yOffsetToName[y],
	        hover = _yOffsetToName$y.hover,
	        full = _yOffsetToName$y.full,
	        short = _yOffsetToName$y.short;
	  ...
	  var draw = function draw(elapsedMS, initialColorScale, finalColorScale) {
	    ...
	    var last_rounded_val = undefined;
	  ...
	  function interpolateScales(a, b, t) {
	    ...
	    var domain = _utils2.default.samplePointsInRange([min, max], _constants.NUM_COLOR_SCALE_INTERPOLATION_SAMPLES);
	    var range = domain.map(function (input) {
...
/***/ function(module, exports) {
	 ...
	 */
	var BASE_PATH_FOR_DEV = 'https://genomevolution.org/coge';
	
	var computeBaseUrl = function computeBaseUrl(loc) {
	  ...
	  if (loc.hostname !== 'localhost') {
	    console.log('Warning: Not sure how to convert the current href ' + ('"' + loc.href + '" into a "base" URL. Using ') + ('"' + BASE_PATH_FOR_DEV + '" instead.'));
	  }
	 ...
	 */
	exports.genCogeSequenceLink = function (id1, id2) {
	  var base = computeBaseUrl(window.location);
	 ...
	 * for details).
	 */
	exports.getSingleFeatureDescription = function (dbId) {
	  var base = computeBaseUrl(window.location);
	  return fetch(base + ('/api/v1/features/' + dbId)).then(function (response) {
...
/***/ function(module, exports) {
	 ...
	 */
	exports.shortenString = function (s, n) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shouldBeMarked = function shouldBeMarked(x, i, A) {
	  ...
	  if (i == 0 && A[i].y >= 0.5 * Math.max.apply(Math, _toConsumableArray(A.map(function (x) {
	    return x.y;
	  })))) {
	    return true;
	  }
	...
	var generateColorScaleFromExtrema = function generateColorScaleFromExtrema(extrema) {
	  ...
	  var domain = colored.map(function (d) {
	    return d.x + d.dx / 2;
	  });
	  var range = colored.map(function (x) {
	    return x.color;
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* Global rules */\n._synteny-dotplot-builder {\n\twidth: 100%;\n\theight: 100%;\n}\n\n/* Brushes */\n._synteny-dotplot-builder .extent {\n  fill: grey;\n  opacity: .2;\n}\n/* axes */\n._synteny-dotplot-builder .domain {\n  fill: none;\n  stroke: black;\n}\n\n/* Borders and background */\n._synteny-dotplot-builder .dotplot,\n._synteny-dotplot-builder #histogram-and-top-form,\n._synteny-dotplot-builder #form-wrapper\n{\n  /* background-color: #F5F5F5;*/\n  border: 1px solid #119911;\n  border-radius: 0px;\n  box-sizing: border-box;\n}\n\n/* Dot plot */\n\n/* The float and position properties here are black magic to get the\n * canvas and svg to sit on top of each other. */\n._synteny-dotplot-builder .dotplot {\n  float: left;\n  position: relative;\n}\n._synteny-dotplot-builder .dotplot:not(#dotplot) {\n  float: left;\n  position: absolute;\n}\n._synteny-dotplot-builder #dotplot {\n  width: 70%;\n  height: 100%;\n}\n/* chromosome boundary lines in dotplot */\n._synteny-dotplot-builder #dotplot .tick line {\n  stroke: rgba(0,0,0, 0.25);\n}\n\n/* chromosome boundary lines in dotplot */\n._synteny-dotplot-builder #dotplot .tick text {\n  font-family: monospace;\n}\n\n\n/* Histograms */\n\n._synteny-dotplot-builder .histogram-button-wrapper {\n\twidth: 80%;\n\tmargin-left: 10%\n}\n\n._synteny-dotplot-builder .histogram-button {\n\tposition: relative;\n  float: left;\n\twidth: 10%;\n\tcolor: grey;\n}\n._synteny-dotplot-builder #histogram-button-title {\n\tposition: relative;\n  float: left;\n\twidth: 80%;\n  text-align: center;\n}\n\n._synteny-dotplot-builder .hidden {\n    display: none;\n}\n\n._synteny-dotplot-builder .pressed {\n\tcolor: black;\n}\n\n._synteny-dotplot-builder #histogram-and-top-form {\n  float: right;\n  width: 28.5%;\n  height: 65%;\n}\n._synteny-dotplot-builder #histogram-wrapper {\n  float: right;\n  width: 100%;\n  height: 90%;\n}\n._synteny-dotplot-builder .histogram {\n  position: relative;\n  width: 100%;\n  height: 100%;\n}\n._synteny-dotplot-builder .histogram .histogram-title {\n  font-size: 14pt;\n}\n/* axis ticks for histograms */\n._synteny-dotplot-builder .histogram .tick line {\n  stroke: grey;\n}\n\n\n/* Forms */\n\n._synteny-dotplot-builder #form-wrapper {\n  margin-top: 1.5%;\n  float: right;\n  width: 28.5%;\n  height: auto;\n  font-size: 14pt;\n}\n._synteny-dotplot-builder #form-wrapper-top {\n  float: right;\n  width: 100%;\n  height: 10%;\n  font-size: 14pt;\n}\n._synteny-dotplot-builder form {\n  display: inline;\n}\n\n#histogram-button-left,\n#histogram-button-right,\n#histogram-button-title {\n    margin-top: 2%;\n}\n\n#form-wrapper strong,\n#form-wrapper text,\n#gevo-link,\n#gevo-link-xname,\n#gevo-link-yname\n{\n    margin-left: 2%;\n}\n\n#gevo-link {\n    margin-bottom: 2%;\n}\n#form-top-label {\n    margin-top: 2%;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(319).crossfilter;
...
/***/ }
/******/ ]);
//# sourceMappingURL=synteny-dotplot-builder.js.map